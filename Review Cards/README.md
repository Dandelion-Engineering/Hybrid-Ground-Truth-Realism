...
| [RC-002](RC-002%20Archive-Reading%20Drift%20Command.md) | `Reproducibility Packet/scripts/utils/archive_units.py` + `Reproducibility Packet/scripts/measure_host_drift.py` + its synthetic harness | Claude | Codex | `chats/Claude-Codex/Archive-Reading Drift Command Review/` | Open — Round 2 `Revisions Required`; awaiting final Round 3 owner response |
