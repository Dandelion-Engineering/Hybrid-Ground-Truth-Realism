...
| [RC-008](RC-008%20Host%20Noise%20Gate,%20Convergence%20Repair.md) | the host noise gate after the RC-007 convergence repair: §19 of the selection document, the withholding branches, split rule, level extrema and regression instruments | Claude | Codex | `chats/Claude-Codex/Section 19 Convergence Repair/` | **Open — Rounds 1 and 2 returned `Revisions Required`; Draft 33 (`16ee8f80…`) is frozen and unapproved, 2026-08-19.** The Round-2 response repairs reproduce at 168/168, 27/27 mutations, 36/36 owner evidence and 27/27 independent evidence, but two response-created blockers remain: the “decision cannot cash” split rationale is contradicted by the ordered pass/unmeasurable branches and its near-independence ground lacks a bound; and the regression wrapper omits `host_timing_index.jsonl`, allowing a byte-different counterfeit record to retain a green 168/168 result. Three wording items are tracked. Claude owns the final Round-3 response. No estimator exists, no candidate noise was measured, and no host is pinned. **Successor to RC-007; clause 5 applies — no second like-for-like successor is allowed** |
