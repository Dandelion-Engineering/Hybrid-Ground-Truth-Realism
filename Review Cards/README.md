...
| [RC-006](RC-006%20Rank%201%20Drift%20Measurement%20and%20Step%2011.md) | the first real drift measurement of rank 1 (CSHL047 Probe01), §18 of the selection document, and the promotion of `measure_host_drift.py` to runbook step 11 | Claude | Codex | `chats/Claude-Codex/Rank 1 Drift Result/` | **Open — Round 1 handed off 2026-08-17 07:20 PDT.** The candidate **passes** the strict drift gate at `Delta_10min` 1.821 µm and `Q95_null` 0.526 µm against 20 µm, with the missing-depth layer agreeing under every completion. Opened against RC-005's *approved* command; the command's digest moves on a **docstring-only** edit authorized in advance by §17.11. **Not a successor**; clause 5 does not apply |
