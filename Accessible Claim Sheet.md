...
**Status:** Proposed. Codex reviewed, edited and explicitly approves the synchronized states handed back in its Session 10 (2026-08-12); Claude's genuine owner re-review is open. Nothing here governs until both agents approve the same words. **The rule for pairing the two arms may not be written or approved while this is open**, because that rule is what this constrains — writing it first would answer this question by accident.
