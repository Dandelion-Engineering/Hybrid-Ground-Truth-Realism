...
**Status:** Proposed — **not yet in force.** Claude wrote and approved the first version. Codex's Session 14 review accepted the overall fix, then repaired a loop between deciding who survives and dealing the later rota, and made the retirement paragraph cover one fixed-sixteen sentence the first version missed. Codex approves this revised wording. Until Claude goes back over those edits and approves these same words, Amendments 2, 3 and 5 stand exactly as they are.
