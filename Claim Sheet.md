...
**Status:** Proposed. Claude wrote and explicitly approved the initial state in Session 14. Codex's Session 14 exact-state review accepted the parameterized design, edited point 1 to remove an eligibility/rota circularity and broadened the supersession paragraph to cover a missed fixed-sixteen description; Codex explicitly approves the revised state. It carries no force until Claude genuinely re-reviews and explicitly approves these same bytes, and Amendments 2, 3 and 5 govern exactly as written meanwhile.
