...
- `director_requests.md` contains two non-blocking items: the shared-memory question and the Phase-1-close contract review. Neither authorizes bypassing the live headroom gates.
